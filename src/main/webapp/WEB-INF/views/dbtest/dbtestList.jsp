    ...
    <c:forEach var="vo" items="${vos}" varStatus="st">
      ...
      <tr id="row${vo.idx}" class="userRow" style="display:none">
        <form name="myform${vo.idx}" method="post" action="${ctp}/dbtest/dbtestUpdateOk">
          <td>${vo.idx}</td>
          <td><input type="text" name="mid" id="mid${vo.idx}" value="${vo.mid}" class="form-control" readonly ></td>
          <td><input type="password" name="pwd" id="mid${vo.pwd}" value="${vo.pwd}" class="form-control"></td>
          <td><input type="text" name="name" id="mid${vo.name}" value="${vo.name}" class="form-control"></td>
          <td><input type="text" name="age" id="mid${vo.age}" value="${vo.age}" class="form-control"></td>
          <td>
            <input type="radio" name="gender" id="gender1${vo.idx}" value="남자" ${vo.gender=='남자' ? 'checked' : ''}>남자<br/>
            <input type="radio" name="gender" id="gender2${vo.idx}" value="여자" ${vo.gender=='여자' ? 'checked' : ''}>여자
          </td>
          <td><input type="text" name="address" id="address${vo.idx}" value="${vo.address}" class="form-control"></td>
  ...
  <div class="row">
    <div class="col-md-6 offset-md-3">
		  <div class="input-group">
		    ...
		    <input type="button" value="검색" onclick="idSearch()" class="btn btn-info"/>
		  </div>
	  </div>
  </div>
</div>
