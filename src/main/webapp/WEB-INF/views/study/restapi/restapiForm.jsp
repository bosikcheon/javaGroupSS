...
<div class="container">
	<h2>REST API 연습</h2>
	<h5>사용예</h5>
	<div>예) 브라우저상에 'Hello Springframework'를 출력시켜 보시오.</div>
	<div>
	  <a href="${ctp}/study/restapi/restapiTest1/Hello Springframework" class="btn btn-warning me-2">호출1(X)</a>
	  <a href="${ctp}/restapi/restapiTest2/Hello Springframework" class="btn btn-warning me-2">호출2(O)</a>
	  <a href="${ctp}/restapi/restapiTest3/Hello Springframework" class="btn btn-warning me-2">호출3(O)</a>
	</div>
	<hr/>
	<div>Fetch를 사용한 JSON자료 호출</div>
	<div><input type="button" value="fetch연습" onclick="fetchCheck()" class="btn btn-success"/></div>
	<div id="demo"></div>
	<hr/>
	<div>
	  <a href="${ctp}/study/restapi/restapiTest4" class="btn btn-primary">강력범죄발생현황</a>
	</div>
	<hr size="10px"/>
  <h3>API란?</h3>
  <pre>
