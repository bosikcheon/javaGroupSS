...
<head>
  ...
  <script>
    ...
    function fCheck1() {
    	myform.action="${ctp}/study/transaction/transactionInput";
    	myform.submit();
    }
    
    function fCheck2() {
    	myform.action="${ctp}/study/transaction/transactionInput2";
    	myform.submit();
    }
    
    function fCheck3() {
    	myform.action="${ctp}/study/transaction/transactionInput3";
    	myform.submit();
    }
    
    function fCheck4() {
    	myform.action="${ctp}/study/transaction/transactionInput4";
    	myform.submit();
    }
  </script>
</head>
...
<div class="container">
  ...
  <div class="text-center">
	  ...
	  <div class="row justify-content-between">
	    ...
	    <div class="col-3">
		    <input type="button" value="전체회원보기" onclick="location.href='${ctp}/study/transaction/transactionForm';" class="btn btn-info mb-2"/>
	    </div>
	  </div>
  </div>
  <div id="userInputTable">
  	...
  	<form name="myform" method="post">
  	  <table class="table table-bordered">
	      ...
	      <tr>
	        <th>나이</th><td><input type="number" name="age" id="age" value="20" class="form-control" placeholder="나이를 입력하세요"/></td>
	      </tr>
	      <tr>
	        <th>성별</th>
	        <td>
	      ...
	      <tr>
	        <th>직업(user2)</th><td><input type="text" name="job" id="job" class="form-control" placeholder="직업을 입력하세요"/></td>
	      </tr>
	      <tr>
	        <td colspan="2" class="text-center">
	          <input type="button" value="가입1(각각 insert)" onclick="fCheck1()" class="btn btn-success me-2" />
	          <input type="button" value="가입2(각각 insert)" onclick="fCheck2()" class="btn btn-success me-2" />
	          <input type="button" value="가입3(동시 insert)" onclick="fCheck3()" class="btn btn-success me-2" />
	          <input type="button" value="가입4(동시 insert(validate처리))" onclick="fCheck4()" class="btn btn-outline-success me-2" />
