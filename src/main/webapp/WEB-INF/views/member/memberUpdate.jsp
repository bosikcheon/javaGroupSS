      ...
      <tr>
        ...
        <td>
          <div class="input-group">
          	...
          	<input type="button" value="닉네임 중복체크" onclick="nickNameAjaxCheck()" id="nickNameBtn" class="btn btn-secondary" />
          </div>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <div class="input-group">
            <div class="input-group-prepend">
	          ...
	          -<input type="text" name="tel2" id="tel2" value="${vo.tel2}" maxlength="4" class="form-control ml-1 mr-1">
	          -<input type="text" name="tel3" id="tel3" value="${vo.tel3}" maxlength="4" class="form-control ml-1">
          </div>
        </td>
      </tr>
      <tr class="mb-2">
        ...
        <td>
          <div class="input-group mb-1">
		      	<input type="text" name="postcode" id="sample6_postcode" value="${vo.postcode}" onclick="sample6_execDaumPostcode()" placeholder="우편번호" class="form-control mr-1" readonly>
						<input type="button" value="우편번호 찾기" onclick="sample6_execDaumPostcode()" class="btn btn-secondary">
					</div>
					<input type="text" name="address" id="sample6_address" value="${vo.address}" onclick="sample6_execDaumPostcode()" placeholder="주소" class="form-control mb-1" readonly>
					<div class="input-group mb-1">
						<input type="text" name="detailAddress" id="sample6_detailAddress" value="${vo.detailAddress}" class="form-control mr-1">
						<input type="text" name="extraAddress" id="sample6_extraAddress" value="${vo.extraAddress}" onclick="sample6_execDaumPostcode()" placeholder="참고항목" class="form-control" readonly>
					</div>
        </td>
      </tr>
      <tr class="mb-2">
        ...
        <td>
          <div class="input-group">
	          <input type="text" name="email1" id="email1" value="${vo.email1}" class="form-control mr-1" required />
    ...
    <table class="table table-borderless">
      <tr>
        <td>
			  ...
			  <td class="text-end">
		    	<button type="button" onclick="location.href='memberMain'" class="btn btn-info mb-2">돌아가기</button>
        </td>
      </tr>
    </table>
